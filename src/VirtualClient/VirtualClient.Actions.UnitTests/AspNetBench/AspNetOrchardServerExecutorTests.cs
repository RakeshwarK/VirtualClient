    ...
    public class AspNetOrchardServerExecutorTests
    {
        ...
        public async Task AspNetOrchardServerExecutorRunsTheExpectedWorkloadCommandInLinux()
        {
            ...
            List<string> expectedCommands = new List<string>()
            {
                "pkill OrchardCore",
                "fuser -n tcp -k 5014",
                $@"{packageDirectory}/dotnet/dotnet publish -c Release --sc -f net9.0 {packageDirectory}/orchardcore/src/OrchardCore.Cms.Web/OrchardCore.Cms.Web.csproj",
                $@"nohup {packageDirectory}/orchardcore/src/OrchardCore.Cms.Web/bin/Release/net9.0/linux-x64/publish/OrchardCore.Cms.Web --urls http://*:5014"
            };
            ...
            this.mockFixture.ProcessManager.OnCreateProcess = (exe, arguments, workingDir) =>
            {
                ...
                if (expectedCommands.Any(c => c == command))
                {
        ...
        public async Task AspNetOrchardServerExecutorRunsTheExpectedWorkloadCommandInWindows()
        {
            ...
            List<string> expectedCommands = new List<string>()
            {
                "pkill OrchardCore",
                "fuser -n tcp -k 5014",
                $@"{packageDirectory}\dotnet\dotnet.exe publish -c Release --sc -f net9.0 {packageDirectory}\orchardcore\src\OrchardCore.Cms.Web\OrchardCore.Cms.Web.csproj",
                $@"nohup {packageDirectory}\orchardcore\src\OrchardCore.Cms.Web\bin\Release\net9.0\win-x64\publish\OrchardCore.Cms.Web --urls http://*:5014",
            };
