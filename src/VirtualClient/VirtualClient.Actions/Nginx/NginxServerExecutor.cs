...
namespace VirtualClient.Actions
{
    ...
    public class NginxServerExecutor : VirtualClientComponent
    {
        ...
        protected override async Task InitializeAsync(EventContext telemetryContext, CancellationToken cancellationToken)
        {
            ...
            // Step 2: Install NginxConfiguration Package
            ...
            // Step 4: Create reset script to leave server as VC found it.
        ...
        protected override async Task ExecuteAsync(EventContext telemetryContext, CancellationToken cancellationToken)
        {
            ...
            if (!cancellationToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    using (BackgroundOperations profiling = BackgroundOperations.BeginProfiling(this, cancellationToken))
                    {
                        ...
                        while (!(serverState.Definition.Timeout() < DateTime.UtcNow))
                        {
                            ...
                            // step 2: Verify client is online.
                ...
                {
                    // Virtual Client is attempting to leave the server as it found it.
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                // We MUST stop the server instances from running before VC exits
        ...
        protected async Task ResetNginxAsync(EventContext telemetryContext, CancellationToken cancellationToken)
        {
            try
            {
                // step 1: Reset config created by virtual client                
        ...
        {
            // Nginx consistently uses stderr for all output (including -V)
